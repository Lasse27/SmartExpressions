...
namespace SmartExpressions.Core.Nodes.Arithmetic
{
	public record DivideNode : ExpressionNode
	{
		...
		public override Operation<object> Evaluate(Evaluator evaluator)
		{
			...
			Operation<decimal> resolvedLeft = EvaluatorHelpers.ResolveDecimal(rawLeft, "Div.1");
			...
			Operation<decimal> resolvedRight = EvaluatorHelpers.ResolveDecimal(rawRight, "Div.2");

...
{
	public record GreaterThanEqualNode : ExpressionNode
	{
		public ExpressionNode Left { get; set; }
		public ExpressionNode Right { get; set; }

		public GreaterThanEqualNode(ExpressionNode left, ExpressionNode right)
		{
			this.Left = left;
			this.Right = right;
		}
		...
		public static Operation<ExpressionNode> Get(Parser parser)
		{
			...
			ExpressionNode node = new GreaterThanEqualNode(dualOperand.Value.Left, dualOperand.Value.Right);
		...
		public override Operation<object> Evaluate(Evaluator evaluator)
		{
			...
			Operation<decimal> resolvedLeft = EvaluatorHelpers.ResolveDecimal(rawLeft, "Gte.1");
			...
			Operation<decimal> resolvedRight = EvaluatorHelpers.ResolveDecimal(rawRight, "Gte.2");

...
{
	public record CoshNode : ExpressionNode
	{
		private const string Keyword = "cosh";

		public ExpressionNode Operand { get; set; }

		/// <inheritdoc/>
		public CoshNode(ExpressionNode operand) => this.Operand = operand;
		...
		public static NodeResult Get(Parser parser)
		{
			...
			ExpressionNode node = new CoshNode(operand.GetValue());
		...
		public override EvaluationResult Evaluate(EvaluationContext ctx)
		{
			...
			double absolute = Math.Cosh(resolved.Value);

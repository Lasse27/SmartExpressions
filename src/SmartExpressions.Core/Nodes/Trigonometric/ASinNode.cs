...
{
	public record ASinNode : ExpressionNode
	{
		private const string Keyword = "asin";

		public ExpressionNode Operand { get; set; }

		/// <inheritdoc/>
		public ASinNode(ExpressionNode operand) => this.Operand = operand;
		...
		public static NodeResult Get(Parser parser)
		{
			...
			ExpressionNode node = new ASinNode(operand.GetValue());
		...
		public override EvaluationResult Evaluate(EvaluationContext ctx)
		{
			...
			double absolute = Math.Asin(resolved.Value);

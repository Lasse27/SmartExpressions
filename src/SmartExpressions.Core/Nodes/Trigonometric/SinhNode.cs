...
{
	public record SinhNode : ExpressionNode
	{
		private const string Keyword = "sinh";

		public ExpressionNode Operand { get; set; }

		/// <inheritdoc/>
		public SinhNode(ExpressionNode operand) => this.Operand = operand;
		...
		public static NodeResult Get(Parser parser)
		{
			...
			ExpressionNode node = new SinhNode(operand.GetValue());
		...
		public override EvaluationResult Evaluate(EvaluationContext ctx)
		{
			...
			double absolute = Math.Sinh(resolved.Value);

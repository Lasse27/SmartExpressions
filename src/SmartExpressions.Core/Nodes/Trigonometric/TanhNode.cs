...
{
	public record TanhNode : ExpressionNode
	{
		private const string Keyword = "tanh";

		public ExpressionNode Operand { get; set; }

		/// <inheritdoc/>
		public TanhNode(ExpressionNode operand) => this.Operand = operand;
		...
		public static NodeResult Get(Parser parser)
		{
			...
			ExpressionNode node = new TanhNode(operand.GetValue());
		...
		public override EvaluationResult Evaluate(EvaluationContext ctx)
		{
			...
			double absolute = Math.Tanh(resolved.Value);

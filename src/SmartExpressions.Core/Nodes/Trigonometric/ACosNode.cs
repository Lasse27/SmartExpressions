...
{
	public record ACosNode : ExpressionNode
	{
		private const string Keyword = "acos";

		public ExpressionNode Operand { get; set; }

		/// <inheritdoc/>
		public ACosNode(ExpressionNode operand) => this.Operand = operand;
		...
		public static NodeResult Get(Parser parser)
		{
			...
			ExpressionNode node = new ACosNode(operand.GetValue());
		...
		public override EvaluationResult Evaluate(EvaluationContext ctx)
		{
			...
			double absolute = Math.Acos(resolved.Value);

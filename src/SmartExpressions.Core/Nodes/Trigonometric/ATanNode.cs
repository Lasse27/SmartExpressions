...
{
	public record ATanNode : ExpressionNode
	{
		private const string Keyword = "atan";

		public ExpressionNode Operand { get; set; }

		/// <inheritdoc/>
		public ATanNode(ExpressionNode operand) => this.Operand = operand;
		...
		public static NodeResult Get(Parser parser)
		{
			...
			ExpressionNode node = new ATanNode(operand.GetValue());
		...
		public override EvaluationResult Evaluate(EvaluationContext ctx)
		{
			...
			double absolute = Math.Atan(resolved.Value);
